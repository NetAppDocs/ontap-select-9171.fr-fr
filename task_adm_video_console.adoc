...
[role="lead"]
Vous pouvez accéder à la console vidéo de la machine virtuelle hyperviseur sur laquelle ONTAP Select est exécuté.
...
. Cliquez avec le bouton droit sur la machine virtuelle et sélectionnez *Ouvrir la console*.
