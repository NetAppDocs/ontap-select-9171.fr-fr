...
Pour démarrer le processus de mise à niveau, téléchargez le fichier de mise à niveau de machine virtuelle ONTAP Select Deploy approprié depuis lelink:https://mysupport.netapp.com/site/["Site de support NetApp"^] . Le package de mise à niveau est formaté dans un fichier compressé unique.

.Étapes
. Accédez àlink:https://mysupport.netapp.com/site/["Site de support NetApp"^] Utilisez un navigateur Web et choisissez *Téléchargements* dans le menu Téléchargements.
